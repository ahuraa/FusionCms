        ...
        <div class="select_tools">
            ...
            <div class="select_tool">
                <div class="tool store_item">
                    ...
                    <br />
                    {if $config->item('name_change_price') > 0}هزینه : {$config->item('name_change_price')} تومان{else}Free of charge{/if}
                    <div class="clear"></div>
                </div>
            </div>
            ...
            <div class="select_tool">
                <div class="tool store_item">
                    ...
                    <br />
                    {if $config->item('race_change_price') > 0}هزینه : {$config->item('race_change_price')} تومات{else}Free of charge{/if}
                    <div class="clear"></div>
                </div>
            </div>
            ...
            <div class="select_tool">
                <div class="tool store_item">
                    ...
                    <br />
                    {if $config->item('faction_change_price') > 0}هزینه : {$config->item('faction_change_price')} تومان{else}Free of charge{/if}
                    <div class="clear"></div>
                </div>
            </div>
            ...
            <div class="select_tool">
                <div class="tool store_item">
                    ...
                    <br />
                    {if $config->item('appearance_change_price') > 0}هزینه : {$config->item('appearance_change_price')} تومان{else}Free of charge{/if}
                    <div class="clear"></div>
                </div>
            </div>
