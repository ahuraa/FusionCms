<section class="box big" id="account_articles">
	...
	<form style="margin-top:0px;" onSubmit="Accounts.searchAccount(); return false;">
		<input dir="rtl" align="right" type="text" name="search_accounts" {if $auto}value="{$data.username}" {/if}id="search_accounts" placeholder="جستجو بوسیله نام کاربری یا پست الکترونیکی" style="width:90%;margin-right:5px;text-align:right;"/>
