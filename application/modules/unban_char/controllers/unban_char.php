...
class unban_char extends MX_Controller 
{
	private $characters;
	private $total;
	...
	*/
	...
	public function index()
	{
		...
		//Set the title
		$this->template->setTitle("Ban Characters");
		...
		$page_data = array(
			"module" => "default", 
				"headline" => " نمایش هیرو های مسدود شده", 
	...
	public function submit()
	{
		...
		{
			die("ریلم سرویس را پشتیبانی نمی کند");
		}
		...
		if ($ToolId && $characterGuid && $realmId)
		{
			...
			if (isset($this->tools[$ToolId]))
			{
				...
				{
					die("هیرو انتخاب شده به اکانت شما تعلق ندارد");
				}
				...
				{
					die("امتیاز ویژه شما کافی نمی باشد");
				}
			}
			else
			{
				die("این سرویس انتخاب شده نامعتبر است.");
			}
		}
		else
		{
			die("مشکلی در ارسال اطلاعات بوجود آمد، لطفا دوباره سعی کنید.");
		}
	}
