	...
	<section id="statistics">
        ...
        {if $realms_count > 0}
        	...
        	<section id="statistics_title" style="margin-top: 10px;">
            	<div style="text-align:right"><h3>برترین تیم های آرنا</h3></div>
            </section>
        	...
        	<section id="statistics_top_arena_teams">
                ...
                <div class="statistics_arena_box">
                    ...
                    {else}
                    	<div class="statistics_arena_item">
                        	<br />تیم 2 به 2 موجود نیست<br /><br />
                        </div>
                    {/if}
                </div>
                ...
                <div class="statistics_arena_box">
                    ...
                    {else}
                    	<div class="statistics_arena_item">
                        	<br />تیم 3 به 3 موجود نیست<br /><br />
                        </div>
                    {/if}
                </div>
                ...
                <div class="statistics_arena_box" style="margin-right: 0;">
                    ...
                    {else}
                    	<div class="statistics_arena_item">
                        	<br />تیم 5 به 5 موجود نیست<br /><br />
                        </div>
                    {/if}
                </div>
        	...
        	<section id="statistics_title" style="margin-top: 40px; margin-bottom: 10px;">
            	<div style="text-align:right"><h3><span dir="rtl">برترین بازیکنان سرور ( رنک بندی بر اساس Kill و Honor )</span></h3></div>
            </section>
                ...
                <table class="nice_table" cellspacing="0" cellpadding="0">
                    ...
                    {if $TopHK}
                        ...
                        <tr>
                            ...
                            <td width="30%"><a data-tip="نمایش پروفایل کاربر" href="{$url}character/{$selected_realm}/{$character.guid}">{$character.name}</a></td>
                  	...
                  	{else}
                    	<tr>
                        	<td colspan="5"><center>بازیکنی موجود نیست</center></td>
                      	</tr>
                	{/if}
                </table>
